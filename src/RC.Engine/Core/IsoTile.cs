    ...
    class IsoTile : IIsoTile
    {
        ...
        private void ValidateNeighbour(MapDirection dir)
        {
            ...
            if (neighbour != null)
            {
                ...
                ITerrainType[] thisNESWRot = RCEngineHelper.GetTerrainNESW(this.type.TerrainA, this.type.TerrainB, thisCombRot);
                ITerrainType[] neighNESWRot = RCEngineHelper.GetTerrainNESW(neighbour.type.TerrainA, neighbour.type.TerrainB, neighCombRot);
                    ...
                    thisNESWRot[0] == this.type.TerrainA && thisNESWRot[1] == this.type.TerrainA)
                {
                    ...
                    while (currTile != null && remaining > 0)
                    {
                        ...
                        ITerrainType[] currNESWRot = RCEngineHelper.GetTerrainNESW(currTile.type.TerrainA, currTile.type.TerrainB, currCombRot);
