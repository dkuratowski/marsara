...
{
    /// <summary>
    /// This static class defines special methods used in the RC.Engine component but logically not part of any
    /// other classes or structures.
    /// </summary>
    static class RCEngineHelper
    {
        ...
        public static TerrainCombination RotateTerrainCombination(TerrainCombination combination, MapDirection origDir, MapDirection newDir)
        {
            ...
            if (newDir != MapDirection.NorthEast)
            {
                ...
                return RCEngineHelper.RotateTerrainCombination(combination,
        ...
        /// </returns>
        public static TerrainType[] GetTerrainNESW(TerrainType a, TerrainType b, TerrainCombination combination)
        {
            ...
            if (combination == TerrainCombination.Simple) { return new TerrainType[4] { a, a, a, a }; }
            if (combination == TerrainCombination.AAAB) { return new TerrainType[4] { a, a, a, b }; }
            if (combination == TerrainCombination.AABA) { return new TerrainType[4] { a, a, b, a }; }
            if (combination == TerrainCombination.AABB) { return new TerrainType[4] { a, a, b, b }; }
            if (combination == TerrainCombination.ABAA) { return new TerrainType[4] { a, b, a, a }; }
            if (combination == TerrainCombination.ABBA) { return new TerrainType[4] { a, b, b, a }; }
            if (combination == TerrainCombination.ABBB) { return new TerrainType[4] { a, b, b, b }; }
            if (combination == TerrainCombination.BAAA) { return new TerrainType[4] { b, a, a, a }; }
            if (combination == TerrainCombination.BAAB) { return new TerrainType[4] { b, a, a, b }; }
            if (combination == TerrainCombination.BABB) { return new TerrainType[4] { b, a, b, b }; }
            if (combination == TerrainCombination.BBAA) { return new TerrainType[4] { b, b, a, a }; }
            if (combination == TerrainCombination.BBAB) { return new TerrainType[4] { b, b, a, b }; }
            if (combination == TerrainCombination.BBBA) { return new TerrainType[4] { b, b, b, a }; }
            throw new ArgumentException("Invalid terrain combination!", "combination");
        }
    }
}
