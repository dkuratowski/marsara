...
namespace RC.Engine.Simulator.PublicInterfaces
{
    ...
    /// </remarks>
    public interface ISimHeapAccess : ISimDataRead, ISimDataWrite
    {
        /// <summary>
        ...
        /// </exception>
        void PointTo(ISimHeapAccess target);
        ...
        /// </exception>
        ISimHeapAccess AccessField(int fieldIdx);
        ...
        /// </exception>
        ISimHeapAccess AccessArrayItem(int itemIdx);
    }
}
