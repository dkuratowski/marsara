...
namespace RC.Engine.Simulator.Core
{
    ...
    /// <summary>
    /// Contains informations about a simulation element type.
    /// </summary>
    class SimElementType
    {
        /// <summary>
        /// Constructs a composite SimElementType.
        /// </summary>
        /// <param name="name">The name of this composite type.</param>
        /// <param name="fields">The fields of this composite type.</param>
        public SimElementType(string name, Dictionary<string, string> fields)
        {
        ...
        /// <summary>
        /// Constructs a built-in SimElementType.
        /// </summary>
        /// <param name="builtInType">The built-in type to be constructed.</param>
        public SimElementType(BuiltInTypeEnum builtInType)
        {
            /// Members filled at initialization.
            switch (builtInType)
            {
                ...
                case BuiltInTypeEnum.Long:
                    ...
                    break;
                default:
                    throw new ArgumentException("The value of 'builtInType' cannot be 'BuiltInTypeEnum.NonBuiltIn'!", "builtInType");
            }
            string name;
        ...
        /// <summary>
        /// Creates a pointer SimElementType that points to the given type.
        /// </summary>
        /// <param name="pointerTypeName">The name of this pointer type.</param>
        /// <param name="pointedTypeID">The ID of the pointed type.</param>
        public SimElementType(string pointerTypeName, short pointedTypeID)
        {
        ...
        /// <summary>
        /// Sets the ID of this SimElementType.
        /// </summary>
        ...
        public void RegisterPointerTypes(ref Dictionary<string, short> typeIDs, ref List<SimElementType> types)
        {
        ...
        /// </summary>
        /// <param name="types">The list of the types.</param>
        public void ComputeFieldOffsets(List<SimElementType> types)
        {
            if (types == null) { throw new ArgumentNullException("types"); }
        ...
        /// <param name="typeIDs">The list of the type IDs mapped by their names.</param>
        /// <param name="types">The list of the types.</param>
        private void RegisterPointer(string pointedTypeName, ref Dictionary<string, short> typeIDs, ref List<SimElementType> types)
        {
            ...
            SimElementType ptrType = new SimElementType(pointerTypeName, typeIDs[pointedTypeName]);
        ...
        private void ComputeFieldOffsetsInternal(List<SimElementType> types, ref HashSet<short> triedTypeIDs)
        {
            if (this.fieldIndices == null) { return; }
            ...
            for (int fieldIdx = 0; fieldIdx < this.fieldTypeIDs.Count; fieldIdx++)
            {
                ...
                SimElementType fieldType = types[fieldTypeID];
