...
namespace RC.App.BizLogic.BusinessComponents
{
    ...
    /// <summary>
    /// The interface of the task manager business component.
    /// </summary>
    /// <remarks>
    /// The RC.App.BizLogic doesn't implements this interface therefore it's public so that it shall be implemented by in another module.
    /// </remarks>
    [ComponentInterface]
    public interface ITaskManagerBC
    {
        /// <summary>
