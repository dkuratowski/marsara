...
namespace RC.App.BizLogic.Services.Core
{
    ...
    /// </summary>
    [Component("RC.App.BizLogic.ViewService")]
    class ViewService : IViewService, IViewFactoryRegistry
    {
        /// <summary>
        ...
        /// <see cref="IViewService.CreateView<TView>"/>
        TView IViewService.CreateView<TView>()
        {
        ...
        /// <see cref="IViewService.CreateView<TView, TParam>"/>
        TView IViewService.CreateView<TView, TParam>(TParam param)
        {
            Delegate factoryMethod = this.GetFactoryMethod_i<TView>();
            if (factoryMethod == null) { return null; }
        ...
        /// <see cref="IViewService.CreateView<TView, TParam0, TParam1>"/>
        TView IViewService.CreateView<TView, TParam0, TParam1>(TParam0 param0, TParam1 param1)
        {
            Delegate factoryMethod = this.GetFactoryMethod_i<TView>();
            if (factoryMethod == null) { return null; }
        ...
        /// <see cref="IViewService.CreateView<TView, TParam0, TParam1, TParam2>"/>
        TView IViewService.CreateView<TView, TParam0, TParam1, TParam2>(TParam0 param0, TParam1 param1, TParam2 param2)
        {
            Delegate factoryMethod = this.GetFactoryMethod_i<TView>();
            if (factoryMethod == null) { return null; }
        ...
        #endregion IViewService members
