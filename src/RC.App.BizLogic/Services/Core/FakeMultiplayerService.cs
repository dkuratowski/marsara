...
namespace RC.App.BizLogic.Services.Core
{
    ...
    /// </summary>
    [Component("RC.App.BizLogic.FakeMultiplayerService")]
    class FakeMultiplayerService : IMultiplayerService, IComponent
    {
        /// <summary>
        /// Constructs a MultiplayerGameManager instance.
        /// </summary>
        public FakeMultiplayerService()
        {
            this.dssTask = null;
        }
        ...
        public void Start()
        {
            TraceManager.WriteAllTrace("FakeMultiplayerService.Start", TraceManager.GetTraceFilterID("RC.App.BizLogic.Info"));
