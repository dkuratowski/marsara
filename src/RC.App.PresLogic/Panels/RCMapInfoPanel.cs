...
namespace RC.App.PresLogic.Panels
{
    ...
    /// </summary>
    public class RCMapInfoPanel : RCAppPanel
    {
        /// <summary>
        /// Creates an RCMapInfoPanel instance.
        /// </summary>
        ...
        /// </param>
        public RCMapInfoPanel(RCIntRectangle backgroundRect, RCIntRectangle contentRect,
