...
namespace RC.Engine.Maps.PublicInterfaces
{
    ...
    {
        /// <summary>
        /// Gets every map content attached to this content manager.
        /// </summary>
        /// <returns>A list that contains every map content attached to this content manager.</returns>
        ...
        /// <returns>A list that contains every map content at the given position.</returns>
        ...
        /// <returns>A list that contains every map content inside the given selection box.</returns>
